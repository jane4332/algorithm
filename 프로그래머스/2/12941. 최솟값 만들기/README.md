...
## 문제점
- 최솟값을 구하는걸 개념적으로 생각했을때 큰 숫자가 배수가 되는걸 막는것이 중요함 = 큰수 * 작은수를 하는걸 먼저 생각하기
- 정렬을 해서 곱하기를 해야한다는 생각을 못함
- 배열 을 순서대로 정렬하는 메서드를 몰랐었음
